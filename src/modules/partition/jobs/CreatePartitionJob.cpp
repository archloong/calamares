...
prettyGptType( const Partition* partition )
{
	...
	{ "77055800-792c-4f94-b39a-98c91b762bb6", "Linux Root Partition (LoongArch 64-bit)" },
        ...
        { "f3393b22-e9af-4613-a948-9d3bfbd0c535", "Linux Root Verity Partition (LoongArch 64-bit)" },
        ...
        { "e611c702-575c-4cbe-9a46-434fa0bf7e3f", "Linux /usr Partition (LoongArch 64-bit)" },
        ...
        { "f46b2c26-59ae-48f0-9106-c50ed47f673d", "Linux /usr Verity Partition (LoongArch 64-bit)" },
